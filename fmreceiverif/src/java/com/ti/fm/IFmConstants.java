...
public interface IFmConstants {
    ...
    public static final float FM_FIRST_FREQ_US_EUROPE_KHZ_FLOAT = new Float(87.5);
    public static final float FM_LAST_FREQ_US_EUROPE_KHZ_FLOAT = new Float(108.0);

    /* Japan band limits */
    public static final int FM_FIRST_FREQ_JAPAN_KHZ = 76000;
    public static final int FM_LAST_FREQ_JAPAN_KHZ = 90000;
    public static final float FM_FIRST_FREQ_JAPAN_KHZ_FLOAT = 76;
    public static final float FM_LAST_FREQ_JAPAN_KHZ_FLOAT = 90;
     ...
     * ********************************************************************************************
     * <p/>
     * OMAPS00207258/OMAPS00207261: Look up tables for RDS data conversion
     * <p/>
     * *********************************************************************************************
     */
    public static char[][] lookUpTable_G0 = {            /* 0 */{'\u0000', '\u0001', '\u0002', '\u0003', '\u0004',
            '\u0005', '\u0006', '\u0007', '\u0008', '\u0009', '\u0000',
            '\u000b', '\u000c', '\u0000', '\u000e', '\u000f'},
			/* 1 */{'\u0010', '\u0011', '\u0012', '\u0013', '\u0014',
            '\u0015', '\u0016', '\u0017', '\u0018', '\u0019', '\u001a',
